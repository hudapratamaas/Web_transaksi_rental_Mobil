...
<div class="btn-group">
    <!--Untuk cetak PDF diarahkan pada function laporan_pdf()-->
    <a class="btn btn-warning btn-sm" href="<?php echo base_url().'admin/laporan_pdf/?dari='.set_value('dari').'&sampai=' .set_value('sampai') ?>">
    <span class="glyphicon glyphicon-print"></span>Cetak PDF</a>
    <!--Untuk print PDF diarahkan pada function laporan_print()-->
    <a class="btn btn-default btn-sm" href="<?php echo base_url().'admin/laporan_print/?dari='.set_value('dari').'&sampai='.set_value('sampai') ?>">
    <span class="glyphicon glyphicon-print">Print</span></a>
</div>
<br/>
<br/>
<div class="table-responsive">
    <table border="1" class="table table-stripped table-hover table-bordered" id="table-datatable">
        <thead>
            <tr>
                <th>No</th>
                <th>Tanggal</th>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <?php 
                    if($l->transaksi_tglkembalikan =="0000-00-00"){
                        echo "-";
                    }else{
                        echo date('d/m/Y',strtotime($l->transaksi_tglkembalikan)); 
                    }
                    ?>
                </td>
