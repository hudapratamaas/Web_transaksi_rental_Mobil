...
<!--Perintah untuk menginputkan form tambah data transaksi berada pada function transaksi_add()-->
        ...
        <tbody>
            ...
            foreach($transaksi as $t){ 
                ...
                <tr>
                    ...
                    <td>
                        <?php 
                        if($t->transaksi_tglkembalikan == strtotime("d/m/Y")){  
                            echo "-";
                        }else{
                            echo date('d/m/Y', strtotime($t->transaksi_tglkembalikan)); 
                        }
                        ?>
                    </td>
                    ...
                    <td> 
                        ...
                        if($t->transaksi_status == "1"){
                            ...
                            ?>
                            <!--Proses transaksi selesai akan diarahkan pada function transaksi_selesai()-->
                            ...
                            <br/>
                            <!--Proses hapus data transaksi akan diarahkan pada function transaksi_hapus()-->
