        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav">
                    ...
                    <!--link yang menampilkan data mobil mengarahkan ke function mobil() pada controller admin.php--> 
                    <li><a href="<?php echo base_url() . 'admin/mobil'; ?>"><span class="glyphicon glyphicon-folder-open"></span> Data Mobil</a></li>
                    <!--link yang menampilkan data kostumer mengarahkan ke function kostumer() pada controller admin.php-->
                    <li><a href="<?php echo base_url() . 'admin/kostumer'; ?>"><span class="glyphicon glyphicon-user"></span> Data Kostumer</a></li>
                    <!--link yang menampilkan data transaksi mengarahkan ke function transaksi() pada controller admin.php-->
                ...
                <ul class="nav navbar-nav navbar-right">
                    <!--Link Logout yang diarahkan ke controller/admin.php-->
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li>
                                <!--Link ganti password yang diarahkan ke controller/admin.php-->
